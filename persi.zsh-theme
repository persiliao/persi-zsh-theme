...
PROMPT='%{$fg[magenta]%}${USER}%{$fg[blue]%}${ret_status}%{$fg[FF5765]%}@%{$fg_bold[green]%}$(persi_pwd)$(persi_dir_writable)%{$reset_color%}$(git_prompt_info)%{$reset_color%}$(persi_user)%{$reset_color%}'
