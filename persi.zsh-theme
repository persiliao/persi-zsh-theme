...
# Display the current working directory with special handling for home
prompt_pwd() {
  local dir_display=${PWD/#$HOME/'🏡️'}
  [[ "${dir_display}" != "🏡️" ]] && dir_display="📂️ ${dir_display##*/}"
  echo -e "${dir_display}"
}

# Display appropriate prompt symbol based on user
...
# Combine all prompt parts to create the final prompt
